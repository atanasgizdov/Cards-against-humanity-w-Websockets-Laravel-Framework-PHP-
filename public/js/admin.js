...
function sendUserName(){
  ...
  document.getElementById('user_name_ui_show').innerHTML = playerName_UIOnly + " - You are an Admin!";
  conn.send(playerName_UIOnly + " - The almighty Admin");
  buildGenericJSON("1");
}
